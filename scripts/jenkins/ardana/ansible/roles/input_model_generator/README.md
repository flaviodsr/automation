...
or define a new one. The scenario template needs to be passed as a parameter to the `generate-input-model.yml` playbook.
...
service_groups:
  - name: clm
    type: cluster
    prefix: c0
    distro_id: sles12sp3-x86_64
    heat_image_id: cleanvm-jeos-SLE12SP3
